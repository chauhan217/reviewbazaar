                ...
                @foreach($companies as $company)
                    <div class="list-wraps bg-white p-4 rounded-3 d-flex mb-3">
                        <div class="list-style1 bg-light p-2 rounded-3 d-flex align-items-center justify-content-center">
                          ...
                          <img class="img-fluid rounded-3 bg-light" src="{{ asset('logos/' . $company->logo) }}" alt="{{ $company->website_url }}">
                          @else
                          <img class="img-fluid rounded-3 bg-light" src="{{ asset('assets/images/company/1.png')}}" alt="{{ $company->website_url }}">
                          @endif
                        </div>
