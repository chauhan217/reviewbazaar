        ...
        <div class="col-md-12">
            <div class="p-4 border bg-light rounded-4">
                <form action="{{ route('profile.blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select js-example-basic-single @error('category') is-invalid @enderror" id="category" name="category">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('meta_key') is-invalid @enderror"
                                    ...
                                    value="{{ old('meta_key', $blog->meta_key) }}">
                                @error('meta_key')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="editor" name="description"
                                    rows="10" cols="80">{{ old('description', $blog->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <input type="hidden" name="status" value="{{ old('status', $blog->status) }}">
